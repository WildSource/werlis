...
/* package werlis-0.1.0.0 */
#ifndef VERSION_werlis
#define VERSION_werlis "0.1.0.0"
#endif /* VERSION_werlis */
#ifndef MIN_VERSION_werlis
#define MIN_VERSION_werlis(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_werlis */
...
#define CURRENT_COMPONENT_ID "werlis-0.1.0.0-inplace-werlis"
